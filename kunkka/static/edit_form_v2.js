...
function create_form(data){
    ...
    for(var field in form_data){                    
        if(fields[field].type=="select"){
            edit_form+='<div class="input-group selector"><span class="input-group-addon">'+field.toUpperCase().replace(/_/g," ")+'</span><select name="'+field.toUpperCase()+'" class="form-control" >'            
        ...
        }else
        {
            ...
            {
                edit_form+='<div class="input-group"><span class="input-group-addon">'+field.toUpperCase().replace(/_/g," ")+'</span><input disabled="true" name="'+field.toUpperCase()+'" type="text" class="form-control" value="'+form_data[field]+'"></div>'
            }            
            else
            {
                edit_form+='<div class="input-group"><span class="input-group-addon">'+field.toUpperCase().replace(/_/g," ")+'</span><input name="'+field.toUpperCase()+'" type="text" class="form-control" value="'+form_data[field]+'"></div>'
            }
