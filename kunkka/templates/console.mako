    ...
    <div class="row">
        ...
        <div class="col-md-2">              
            <div class="btn-group-sm">              
                <button type="button" class="run btn btn-primary" onclick="run();">Run</button>
                <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
                <span class="caret"></span>
                <span class="sr-only">Toggle Dropdown</span>
              </button>
              <ul class="dropdown-menu" role="menu">                
                <li><a href="#" onclick="open_query();">Open</a></li>
                <li class="divider"></li>
                <li><a href="#" onclick="open_editor();">New</a></li>
              </ul>             
            </div>      
        </div>      
    </div>  
...
<%block name="inner_content">
	...
	<div class="row box_me" id="arguments_window" style="height:50px;">
    ...
    <div class="row" id="editor_window" style="height:400px;display:none;">
        <br/>
        <div class="col-md-1 input-group input-group-sm" style="height:100%;">
            <div class="row">                                   
                <div class="col-md-12 input-group input-group-sm" style="height:100%;">
                    <span style="border:solid 1px;" class="input-group-addon">Arguemnt Count</span>
                    </select>           
                </div>
            </div>
            <div class="row">                                   
        ...
        <div class="col-md-10" style="height:100%;">
            <div class="row" style="height:40px;">
                ...
                <div class="col-md-3 btn-group btn-group-xs">                                   
                ...
                <div class="col-md-1 btn-group btn-group-xs">                                   
    ...
    <div class="row" id="report_window" style="display:none;">
        <div class="row" name="toolbar" >
            <div class="btn-toolbar" role="toolbar">
              <div class="col-md-3 btn-group btn-group-sm input-group">     
